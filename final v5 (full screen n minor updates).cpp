...
Text text_slide_word("",font,52);
text_slide_word.setColor(Color::White);
text_slide_word.setStyle(Text::Bold);
...
if (lives<=3)
{
text_lives.setColor(Color::Red);
display_lives.setColor(Color::Red);
}
